...
![](RackMultipart20210319-4-1fq9oap_html_df586b5b0f89fb1d.gif)
...
Gemeenten werken samen met steeds meer partijen. Afspraken en standaarden zijn nodig om effectief, efficiënt en veilig samen te werken en informatie uit te wisselen.
# 7
 Standaarden dragen er bovendien aan bij dat gemeenten zelf, en niet hun leveranciers &#39;in control&#39; zijn over toegang tot en gebruik van gemeentelijke gegevens. Net zoals bij de landelijke basisregistraties is gebeurd, standaardiseren gemeenten in een gegevenslandschap daarom de (gemeentelijke) brongegevens die zij beheren.
# 8
...
# 9
 Bij het beschikbaar maken van open data wordt (naast eventuele andere kanalen) bij voorkeur gebruik gemaakt van de daarvoor beschikbare overheidsbrede publicatiekanalen (bijvoorbeeld data.overheid.nl of het Nationaal Georegister).
# 10
...
In lijn met het gegevenslandschap-standaardisatieprincipe is het raadsvergaderingendomein door VNG Realisatie gegeneraliseerd en gemodelleerd in het informatiemodel Open Raadsinformatie.
# 11
 Een op dit model gebaseerde REST JSON-interface geeft toegang tot in het raadsinformatieregister opgeslagen gegevens. Deze interface is eveneens gespecificeerd door VNG Realisatie en sluit aan bij de API-strategie voor de Nederlandse overheid.
# 12

![](RackMultipart20210319-4-1fq9oap_html_9136c1bb99f26360.gif)
...
![](RackMultipart20210319-4-1fq9oap_html_379bd8dc137fa8f8.gif)

[1](#sdfootnote1anc) GitHub-pagina open raadsinformatie ([https://github.com/openstate/open-raadsinformatie](https://github.com/openstate/open-raadsinformatie)).

[2](#sdfootnote2anc) GitHub-pagina APIs open raadsinformatie ([https://github.com/ontola/ori-search/blob/master/docs.md](https://github.com/ontola/ori-search/blob/master/docs.md)).

[3](#sdfootnote3anc) Ibid.

[4](#sdfootnote4anc) Ibid.

[5](#sdfootnote5anc) Wat is Common Ground? ([https://commonground.nl/cms/view/54476259/wat-is-common-ground](https://commonground.nl/cms/view/54476259/wat-is-common-ground)).

[6](#sdfootnote6anc) Principes informatiearchitectuur GEMMA gegevenslandschap, p. 12. ([https://redactie.gemmaonline.nl/images/redactiegemma/6/67/20190328\_-\_Gemeentelijk\_Gegevenslandschap\_-\_Informatiearchitectuurprincipes.pdf](https://redactie.gemmaonline.nl/images/redactiegemma/6/67/20190328_-_Gemeentelijk_Gegevenslandschap_-_Informatiearchitectuurprincipes.pdf)).

[7](#sdfootnote7anc) Principes informatiearchitectuur GEMMA gegevenslandschap, p. 14.

[8](#sdfootnote8anc) Principes informatiearchitectuur GEMMA gegevenslandschap, p. 11.

[9](#sdfootnote9anc) Beschrijving informatiearchitectuur GEMMA Gegevenslandschap, p. 27. ([https://www.gemmaonline.nl/images/gemmaonline/5/56/GEMMA\_Gegevenslandschap\_-\_Beschrijving\_informatiearchitectuur.pdf](https://www.gemmaonline.nl/images/gemmaonline/5/56/GEMMA_Gegevenslandschap_-_Beschrijving_informatiearchitectuur.pdf)).

[10](#sdfootnote10anc) Principes informatiearchitectuur GEMMA gegevenslandschap, p. 7 en 8.

[11](#sdfootnote11anc) GitHub-pagina ODS Open Raadsinformatie ([https://github.com/VNG-Realisatie/ODS-Open-Raadsinformatie](https://github.com/VNG-Realisatie/ODS-Open-Raadsinformatie)).

[12](#sdfootnote12anc) API-strategie voor de Nederlandse overheid ([https://docs.geostandaarden.nl/api/API-Strategie/](https://docs.geostandaarden.nl/api/API-Strategie/), Informatiemodel Open Raadsinformatie ([https://www.vngrealisatie.nl/sites/default/files/2018-08/20180701%20informatiemodel%20ORI%20vs1\_01%20.pdf](https://www.vngrealisatie.nl/sites/default/files/2018-08/20180701%20informatiemodel%20ORI%20vs1_01%20.pdf)).

![](RackMultipart20210319-4-1fq9oap_html_da6b4288f80bd662.gif)
...
_V ![](RackMultipart20210319-4-1fq9oap_html_152eb09e054afaeb.gif) ersie 0.2 – 26 maart 2020_
